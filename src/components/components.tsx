...
export function Header(){return <header className="site-header"><Wordmark/><nav aria-label="Primary navigation"><Link href="/readiness">Readiness</Link><Link href="/paths">Paths</Link><Link href="/guides">Guides</Link></nav><Link className="button button-small" href="/readiness">Check Your Digital Readiness</Link></header>}
