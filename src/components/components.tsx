...
export function Header(){
  const links=[["/","Home"],["/guides","Guides"],["/dns","DNS Checker"],["/email-security","Email Security"],["/domains","Domain Search"]] as const;
