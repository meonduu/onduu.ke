...
export function Header(){return <header className="site-header"><Wordmark/><nav aria-label="Primary navigation"><Link href="/paths">Paths</Link><Link href="/guides">Guides</Link><Link href="/dns">DNS Checker</Link><Link href="/email-security">Email Security</Link><Link href="/kedomains">Domain Search</Link></nav><Link className="button button-small" href="/readiness">Check Your Digital Readiness</Link></header>}
