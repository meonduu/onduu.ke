    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Registration, billing, renewal and support happen at HOSTAFRICA, not on this site",
    ...
    sections: [
      ...briefPages["digital-fitness"].sections,
      {
        ...
        body: [
          ...
          "Onduu does not automatically transmit your assessment answers to either destination. No independent provider and no HOSTAFRICA team sees them unless you approve a specific introduction. Your answers are handled inside Ujiajiri Enterprises Limited, which operates this site, and by the assessment agents: HOSTAFRICA servers, and language models operated by Anthropic and OpenAI. Those receive the substance of your answers with your name, email address and company name removed first — which removes you personally, though the domain still identifies the business. The routes are plain outbound links you follow yourself.",
