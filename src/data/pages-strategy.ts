    ...
    sections: [
      ...briefPages["digital-fitness"].sections,
      {
        ...
        body: [
          ...
          "Onduu does not automatically transmit your assessment answers to either destination. No independent provider and no HOSTAFRICA team sees them unless you approve a specific introduction. Your answers are handled inside Ujiajiri Enterprises Limited, which operates this site, and on the HOSTAFRICA servers its assessment agents run on — which hold the substance of your answers with your name, email address and company name removed first, so your identity never leaves Onduu. The routes are plain outbound links you follow yourself.",
