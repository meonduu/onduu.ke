    ...
    "body": [
      ...
      },
      {
        ...
        "nodes": [
          {
            "t": "em",
            "v": "Disclosure: registration links in the domain search go to HOSTAFRICA, where I am Managing Director of the Kenyan business. Onduu earns no commission on them. How those links are tagged is set out on the commercial relationships page."
          }
        ]
      },
      {
