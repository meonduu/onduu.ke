    ...
    "intro": "What Onduu collects when you use this website, why it is collected, who else can see it, how long it is kept and what you can ask for.",
      ...
      },
      {
        ...
        "cards": [
          ...
          {
            "title": "Anthropic and OpenAI",
            "body": "Operate the language models Onduu\u0027s assessment agents call. Each receives the substance of an assessment \u2014 the declared answers, the domain and the public evidence \u2014 without your name, email address or company name. Both are outside Kenya. Added 22 August 2026."
          },
          {
            "title": "Slack",
      ...
      },
      {
        ...
        "body": [
          ...
          "Specifically: the database runs in Cloudflare's Eastern Europe region, as a single copy with no replicas elsewhere. The website itself is served from whichever Cloudflare location is nearest the visitor, which is how a global network works. Assessment content travels further still: the agents run on HOSTAFRICA servers and call models operated by Anthropic and OpenAI, both outside Kenya. Which transfer safeguard applies to those is one of the points still to be decided below.",
